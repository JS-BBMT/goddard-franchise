...
export class EditFacultyMembersComponent extends AppComponentBase implements OnInit, OnDestroy {
    ...
    @ViewChild('clearSpotlightedFacultyModal', { static: true }) clearSpotlightedModal: ModalDirective;
    ...
    private saveFacultyObservable() {
        return this.facultyApiClientFacade.saveFaculty([
            PostFacultyBiosRequest.fromJS({ ...this.facultyMember }),
        ]);
    }
